# ALB Security Group — the only thing the internet can reach
...
# EC2 Security Group — only accepts traffic from ALB and Bastion
# This means EC2 is never directly reachable from the internet
